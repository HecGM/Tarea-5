...
**Estudie el efecto de cambios en la tasa de interés de México sobre la curva de tasas de interés: [2 horas, 1.5 puntos cada inciso]. Por favor documente su trabajo para que se pueda replicar.**

```{r librerias, echo=FALSE}
#Librerias Necesarias
pacman::p_load(ggplot2,dplyr,siebanxicor,stargazer)
```
